inherited RepOrderListStockTransfer: TRepOrderListStockTransfer
  Caption = 'Lista de Transfer'#234'ncia de Estoque'
  ExplicitWidth = 320
  ExplicitHeight = 240
  PixelsPerInch = 96
  TextHeight = 13
  inherited Qrpt: TQuickRep
    ...
    ReportTitle = 'Rela'#231#227'o de pedidos de transfer'#234'ncias de estoques'
