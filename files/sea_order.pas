...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_search, uniEdit, uniMemo,
  uniDateTimePicker, uniLabel, Datasnap.Provider, Data.DB, Datasnap.DBClient,FireDAC.Stan.Param,
  uniButton, uniBitBtn, uniSpeedButton, uniGUIClasses, uniBasicGrid, uniDBGrid,
  uniGUIBaseClasses, uniPanel, uniCheckBox, uniPageControl,unFunctions,
