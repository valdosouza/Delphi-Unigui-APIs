unit tblOrderItemDetailOptional;
...
Type
  ...
  [TableName('tb_order_item_detail_optional')]
  TOrderItemDetailOptional = Class(TGenericEntity)
  private
  ...
  public
    ...
    [KeyField('tb_order_item_detail_id')]
...
{ TOrderItemDetailOptional }

procedure TOrderItemDetailOptional.setFcreated_at(const Value: TDAteTime);
begin
  Fcreated_at := Value;
end;

procedure TOrderItemDetailOptional.setFId(const Value: Integer);
begin
  FId := Value;
end;

procedure TOrderItemDetailOptional.setFtb_institution_id(const Value: Integer);
begin
  Ftb_institution_id := Value;
end;

procedure TOrderItemDetailOptional.setFtb_order_id(const Value: Integer);
begin
  Ftb_order_id := Value;
end;

procedure TOrderItemDetailOptional.setFtb_order_item_detached_id(
  const Value: Integer);
begin
  Ftb_order_item_detached_id := Value;
end;

procedure TOrderItemDetailOptional.setFtb_order_item_detail_id(
  const Value: Integer);
begin
  Ftb_order_item_detail_id := Value;
end;

procedure TOrderItemDetailOptional.setFtb_order_item_id(const Value: Integer);
begin
  Ftb_order_item_id := Value;
end;

procedure TOrderItemDetailOptional.setFtb_product_id(const Value: Integer);
begin
  Ftb_product_id := Value;
end;

procedure TOrderItemDetailOptional.setFterminal(const Value: Integer);
begin
  Fterminal := Value;
end;

procedure TOrderItemDetailOptional.setFupdated_at(const Value: TDAteTime);
begin
  Fupdated_at := Value;
end;
